...
namespace DIRECTION_GESTOR.Migrations
{
    ...
    [Migration("20191124052516_directionGestorMigration3")]
    partial class directionGestorMigration3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Empleadosinstituciones", b =>
                {
                    b.Property<int>("IdEmpleadoInstitucion")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("idEmpleadoInstitucion")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("IdEmpleadoInstitucion");

                    b.HasIndex("CodigoEmpleadoFk");

                    b.HasIndex("IdInstitucionFk");

                    b.ToTable("EMPLEADOSINSTITUCIONES");
                });
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Estudiantesinstituciones", b =>
                {
                    b.Property<int>("IdEmpleadoInstitucion")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("idEmpleadoInstitucion")
                    ...
                    b.ToTable("ESTUDIANTESINSTITUCIONES");
                });
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Institucionesarchivos", b =>
                {
                    b.Property<int>("IdArchivo")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("idArchivo")
                    ...
                    b.ToTable("INSTITUCIONESARCHIVOS");
                });
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Personas", b =>
                {
                    ...
                    b.Property<int>("IdSexoFk")
                        .HasColumnName("idSexoFK");

                    b.Property<string>("NacionalidadPaisFk")
                        .IsRequired()
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Sexos", b =>
                {
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Empleadosinstituciones", b =>
                {
                    b.HasOne("DIRECTION_GESTOR.Models.Empleados", "CodigoEmpleadoFkNavigation")
                        .WithMany("Empleadosinstituciones")
                        .HasForeignKey("CodigoEmpleadoFk")
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Estudiantesinstituciones", b =>
                {
                    b.HasOne("DIRECTION_GESTOR.Models.Estudiantes", "CodigoEstudianteFkNavigation")
                        .WithMany("Estudiantesinstituciones")
                        .HasForeignKey("CodigoEstudianteFk")
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Institucionesarchivos", b =>
                {
                    b.HasOne("DIRECTION_GESTOR.Models.Instituciones", "IdInstitucionFkNavigation")
                        .WithMany("Institucionesarchivos")
                        .HasForeignKey("IdInstitucionFk")
            ...
            modelBuilder.Entity("DIRECTION_GESTOR.Models.Personas", b =>
                {
                    ...
                    b.HasOne("DIRECTION_GESTOR.Models.Sexos", "IdSexoFkNavigation")
                        .WithMany("Personas")
                        .HasForeignKey("IdSexoFk")
                        .HasConstraintName("FK__PERSONAS__idSexo__0880433F");

                    b.HasOne("DIRECTION_GESTOR.Models.Paises", "NacionalidadPaisFkNavigation")
                        .WithMany("Personas")
                        .HasForeignKey("NacionalidadPaisFk")
